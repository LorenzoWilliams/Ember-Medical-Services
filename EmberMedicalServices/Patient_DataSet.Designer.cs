...
namespace Ember_Medical_Services {
    ...
    public partial class Patient_DataSet : global::System.Data.DataSet {
        ...
        public partial class PatientsDataTable : global::System.Data.TypedTableBase<PatientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PatientsRow AddPatientsRow(string FirstName, string LastName, string Gender, System.DateTime D_O_B, string Address, string Email, string Phone) {
        ...
        public partial class PatientsRow : global::System.Data.DataRow {
            ...
            public System.DateTime D_O_B {
                get {
                    return ((global::System.DateTime)(this[this.tablePatients.D_O_BColumn]));
                }
                set {
                    this[this.tablePatients.D_O_BColumn] = value;
                }
            }
...
namespace Ember_Medical_Services.Patient_DataSetTableAdapters {
    ...
    public partial class PatientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Patients] WHERE (([id] = @Original_id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Gender] = @Original_Gender) AND ([D.O.B] = @p2) AND ([Address] = @Original_Address) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Patients] ([FirstName], [LastName], [Gender], [D.O.B], [Address], [Email], [Phone]) VALUES (@FirstName, @LastName, @Gender, @p1, @Address, @Email, @Phone);
SELECT id, FirstName, LastName, Gender, [D.O.B], Address, Email, Phone FROM Patients WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patients] SET [FirstName] = @FirstName, [LastName] = @LastName, [Gender] = @Gender, [D.O.B] = @p1, [Address] = @Address, [Email] = @Email, [Phone] = @Phone WHERE (([id] = @Original_id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Gender] = @Original_Gender) AND ([D.O.B] = @p2) AND ([Address] = @Original_Address) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone));
SELECT id, FirstName, LastName, Gender, [D.O.B], Address, Email, Phone FROM Patients WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ember_Medical_Services.Properties.Settings.Default.Ember_medical_service_dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, FirstName, LastName, Gender, [D.O.B], Address, Email, Phone FROM dbo.P" +
                "atients";
        ...
        public virtual int Fill(Patient_DataSet.PatientsDataTable dataTable) {
        ...
        public virtual Patient_DataSet.PatientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Patient_DataSet.PatientsDataTable dataTable = new Patient_DataSet.PatientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Patient_DataSet.PatientsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_FirstName, string Original_LastName, string Original_Gender, System.DateTime p2, string Original_Address, string Original_Email, string Original_Phone) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Gender, System.DateTime p1, string Address, string Email, string Phone) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Gender, System.DateTime p1, string Address, string Email, string Phone, int Original_id, string Original_FirstName, string Original_LastName, string Original_Gender, System.DateTime p2, string Original_Address, string Original_Email, string Original_Phone) {
            return this.Update(FirstName, LastName, Gender, p1, Address, Email, Phone, Original_id, Original_FirstName, Original_LastName, Original_Gender, p2, Original_Address, Original_Email, Original_Phone, Original_id);
        }
    }
